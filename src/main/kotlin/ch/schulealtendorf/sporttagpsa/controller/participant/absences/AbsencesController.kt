...
class AbsencesController(
    ...
    fun index(model: Model): String {
        ...
        return "participant/absences/absences-clazz-list"
    }
    ...
    fun getClazz(@PathVariable id: Int, model: Model): String {
        ...
        model.addAttribute("absencesForm", AbsencesForm(competitorList))

        return "participant/absences/absences"
    }

    @PostMapping("/{id}")
    fun saveAbsences(@PathVariable id: Int, @Valid @ModelAttribute("absencesForm") absencesForm: AbsencesForm,  redirectAttributes: RedirectAttributes): String {

        absencesForm.competitorList
                .groupBy { it.absent }
                .forEach {
        ...
        return "redirect:/participant/absences/$id"
    }
