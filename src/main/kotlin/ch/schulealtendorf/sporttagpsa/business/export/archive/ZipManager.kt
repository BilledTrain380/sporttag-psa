...
import ch.schulealtendorf.sporttagpsa.business.storage.StorageSupplier
...
@Component
class ZipManager(
        private val storageSupplier: StorageSupplier
): ArchiveManager {
    ...
    override fun createArchive(files: Iterable<File>): File {
        ...
        val zipFile = storageSupplier.get().resolve(ZIP_OUTPUT)
