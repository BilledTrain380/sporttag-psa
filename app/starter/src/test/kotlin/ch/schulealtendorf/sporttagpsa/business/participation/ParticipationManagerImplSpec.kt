...
object ParticipationManagerImplSpec : Spek({
    ...
    Feature("participate") {
        ...
        Scenario("participant could not be found") {
            ...
            Then("should throw a no such element exception, indicating that the participant does not exist") {
        ...
        Scenario("closed participation") {
            ...
            Then("should throw an illegal state exception, indicating that this operation can not be performed") {
    ...
    Feature("re-participate") {
        Scenario("changing sport from any other to athletics") {
            whenever(mockParticipationRepository.findById(any())).thenReturn(
                Optional.of(
                    ParticipationEntity(
                        "main",
            ...
            Then("should save the participant as competitor with default results") {
            ...
            Then("should consider the category") {
                verify(mockCategoryBook, times(3)).getDistance(any())
            }

            Then("should change the sport to athletics") {
                val expected = participantEntity.copy(sport = SportEntity(ATHLETICS))
                verify(mockParticipantRepository, times(1)).save(expected)
            }
        }

        Scenario("changing sport from athletics to any other") {
            whenever(mockParticipationRepository.findById(any())).thenReturn(
                Optional.of(
                    ParticipationEntity(
                        "main",
            ...
            Then("should remove the competitor entry") {
                verify(mockCompetitorRepository, times(1)).delete(competitor)
            }

            Then("should change the sport") {
        ...
        Scenario("same sport as the participant already has") {
            whenever(mockParticipationRepository.findById(any())).thenReturn(
                Optional.of(
                    ParticipationEntity(
                        "main",
            ...
            Then("should not update or create any data") {
        ...
        Scenario("changing sport from athletics to any other, but the participant is not a competitor") {
            whenever(mockParticipationRepository.findById(any())).thenReturn(
                Optional.of(
                    ParticipationEntity(
                        "main",
            ...
            Then("should not remove any competitor") {
    ...
    Feature("close participation") {
        Scenario("open participation") {
            ...
            Then("should create competitors with default results for each participant with sport athletics") {
                /*
        ...
        Scenario("already closed participation") {
            ...
            Then("should not perform any interactions") {
