...
object ParticipantManagerImplSpec : Spek({
    ...
    Feature("save a participant") {
        ...
        Scenario("new participant") {
            ...
            Then("should create the participant") {
        ...
        Scenario("unkown group") {
            ...
            Then("should throw a no such element exception, indicating that the group does not exist") {
