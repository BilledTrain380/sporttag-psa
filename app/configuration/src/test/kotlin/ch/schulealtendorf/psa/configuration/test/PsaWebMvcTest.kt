...
import ch.schulealtendorf.psa.configuration.web.authorization.PSAUserDetailService
...
@Tag("ctrl-test")
@SpringBootTest
@Import(PSAUserDetailService::class)
...
class PsaWebMvcTest {
    ...
    @Autowired
    private lateinit var userDetailsService: PSAUserDetailService
